...
The project includes automated GitHub Actions workflows for building Android APKs.

### Automatic Builds (Every Push)
Every push to `main` automatically triggers a debug APK build. 

**Download the APK:**
1. Go to **Actions** tab in GitHub
2. Click on the latest **"Build Android APK"** workflow run
3. Scroll down to **Artifacts** section
4. Download `cerebrum-debug-apk`

### Manual Release Build
For production releases with signing:
1. Go to **Actions** tab → **Build Android APK (Production)**
2. Click **Run workflow**
3. Select release type (internal/beta/production)
4. Optional: Enter version name
...
2. Enable **Install from Unknown Sources**:
   ...
   - Tap APK → Settings → Allow from this source
3. Install the APK

### Production Signing Setup
To create signed release builds, you need to set up a keystore:

**See full guide:** [`docs/ANDROID_KEYSTORE_SETUP.md`](docs/ANDROID_KEYSTORE_SETUP.md)

**Quick setup:**
1. Generate keystore: `keytool -genkey -v -keystore release.keystore -alias cerebrum -keyalg RSA -keysize 2048 -validity 10000`
2. Convert to base64: `base64 -i release.keystore`
