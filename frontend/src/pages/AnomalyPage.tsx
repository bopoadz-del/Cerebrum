...
// Define the expected structure for anomaly details
            ...
            <Card>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">{((result.details as AnomalyDetails)?.totalPoints ?? 0).toLocaleString()}</p>
                </div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">{(result.details as AnomalyDetails)?.anomalies}</p>
                </div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">{(result.details as AnomalyDetails)?.confidence}%</p>
                </div>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-4 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold">{(result.details as AnomalyDetails)?.threshold}</p>
                </div>
              </CardContent>
            </Card>
          </div>
              ...
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={chartData}>
                    ...
                    />
                    <ReferenceLine
                      y={(result.details as AnomalyDetails)?.threshold}
                      stroke="#ef4444"
                      strokeDasharray="5 5"
                      label="Threshold"
                    />
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {((result.details as AnomalyDetails)?.anomalyList)?.map((anomaly, index) => (
                  <div
                    key={index}
