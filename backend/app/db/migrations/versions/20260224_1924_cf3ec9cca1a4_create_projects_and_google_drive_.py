...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("type", sa.String(length=64), nullable=False, server_default=sa.text("\'unknown\'")),
    ...
    op.create_table(
        ...
        sa.Column("tags", sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")),
        sa.Column("indexing_status", sa.String(length=32), nullable=False, server_default=sa.text("\'idle\'")),
