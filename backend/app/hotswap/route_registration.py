...
def get_route_registry(app=None) -> RouteRegistry:
    """Get the route registry singleton instance."""
    global _route_registry
    if _route_registry is None:
        if app is None:
            # Try to get app from main module
            try:
                from app.main import app
            except ImportError:
                raise ValueError("FastAPI app must be provided or available in app.main")
