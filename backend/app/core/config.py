...
class Settings(BaseSettings):
    ...
    API_BASE_URL: Optional[str] = Field(
        default=None,
        description="Base URL for internal API calls (e.g., http://localhost:8000). Auto-computed if not set.",
    )
    ...
    CORS_ORIGINS: str = Field(
        default="http://localhost:3000,https://cerebrum-frontend.onrender.com,https://cerebrum.ai,https://*.cerebrum.ai,https://*.onrender.com",
    ...
    BRAVE_API_KEY: Optional[str] = Field(
        default=None,
        description="Brave Search API key for web search feature",
    )
    WEB_SEARCH_ENABLED: bool = Field(
        default=True,
        description="Enable/disable web search feature",
    )
    ...
    OPENAI_API_KEY: Optional[str] = Field(
        default=None,
        description="OpenAI API key for Whisper transcription and other AI features",
    )
    ...
    # =================================================================
    LAYOUTLM_MODEL_PATH: Optional[str] = Field(
        default=None,
        description="Path to LayoutLM model for document classification",
    )
    ...
    # Monitoring Settings
    # =================================================================
    SPLUNK_URL: Optional[str] = Field(
        default=None,
        description="Splunk URL for security monitoring",
    )
    SPLUNK_HEC_TOKEN: Optional[str] = Field(
        default=None,
        description="Splunk HEC token for security monitoring",
    )
    ...
    def api_base_url(self) -> str:
        ...
        Returns the configured API_BASE_URL or constructs one from HOST and PORT.
        Uses localhost for 0.0.0.0 binding since 0.0.0.0 is not a valid connect target.
        """
        if self.API_BASE_URL:
            return self.API_BASE_URL.rstrip("/")
        # When binding to 0.0.0.0, use localhost for internal connections
