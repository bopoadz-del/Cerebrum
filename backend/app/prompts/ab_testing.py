...
# Configuration class for A/B testing
@dataclass
class ABTestConfig:
    """Configuration for A/B testing."""
    default_traffic_split: float = 50.0
    default_min_sample_size: int = 100
    default_success_metric: str = "syntax_success_rate"
...
# Singleton instance
_ab_test_framework: Optional[ABTestFramework] = None


def get_ab_testing_framework() -> ABTestFramework:
    """Get the A/B testing framework singleton instance."""
