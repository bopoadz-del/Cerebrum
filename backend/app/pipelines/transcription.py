...
class WhisperTranscriber:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.has_valid_key = bool(self.api_key and self.api_key != "your-openai-key-here")
        if OPENAI_AVAILABLE and self.has_valid_key:
    ...
    async def transcribe(
        ...
        if not self.has_valid_key:
            raise RuntimeError(
                ...
                "Set OPENAI_API_KEY in your environment or Render dashboard."
            )
