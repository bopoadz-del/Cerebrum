...
class IFCGeometryExtractor:
    ...
    def initialize_settings(
        ...
        """Initialize geometry settings for ifcopenshell 0.8+."""
        self._settings = ifcopenshell.geom.settings()
        # Use string-based settings for ifcopenshell 0.8+
        self._settings.set('use-world-coords', use_world_coords)
        self._settings.set('weld-vertices', weld_vertices)
        self._settings.set('convert-back-units', convert_back_units)
        self._settings.set('validate', validate)
